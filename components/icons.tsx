  ...
  return (
    ...
    >
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M11.5 7C11.5 9.48528 9.48528 11.5 7 11.5C4.51472 11.5 2.5 9.48528 2.5 7C2.5 4.51472 4.51472 2.5 7 2.5C9.48528 2.5 11.5 4.51472 11.5 7ZM11.4546 11.4546C10.1723 12.4233 8.6188 13 7 13C3.68629 13 1 10.3137 1 7C1 3.68629 3.68629 1 7 1C10.3137 1 13 3.68629 13 7C13 8.6188 12.4233 10.1723 11.4546 11.4546L14.7071 14.7071L14.7071 14.7071C15.0976 15.0976 15.0976 15.7308 14.7071 16.1213C14.3166 16.5118 13.6834 16.5118 13.2929 16.1213L10.0404 12.8688C9.94792 12.7764 9.87281 12.67 9.81601 12.554L11.4546 11.4546Z"
        fill="currentColor"
      />
    </svg>
  );
...
export const PoppySkullIcon = ({ size = 16 }: { size?: number }) => {
  return (
    <svg
      width={size}
      height={size}
    ...
    >
      ...
      />
      <path 
        d="M400 720C576.731 720 720 576.731 720 400C720 223.269 576.731 80 400 80C223.269 80 80 223.269 80 400C80 576.731 223.269 720 400 720Z" 
        fill="#FFF8E0"
      />
      <path 
        d="M512 320C583.856 320 642 261.856 642 190C642 118.144 583.856 60 512 60C440.144 60 382 118.144 382 190C382 261.856 440.144 320 512 320Z" 
        fill="#1D0056"
      />
      <path 
        d="M288 320C359.856 320 418 261.856 418 190C418 118.144 359.856 60 288 60C216.144 60 158 118.144 158 190C158 261.856 216.144 320 288 320Z" 
        fill="#1D0056"
      />
      <path 
        d="M512 280C561.706 280 602 239.706 602 190C602 140.294 561.706 100 512 100C462.294 100 422 140.294 422 190C422 239.706 462.294 280 512 280Z" 
        fill="#FFFFFF"
      />
      <path 
        d="M288 280C337.706 280 378 239.706 378 190C378 140.294 337.706 100 288 100C238.294 100 198 140.294 198 190C198 239.706 238.294 280 288 280Z" 
        fill="#FFFFFF"
      />
      <path 
        d="M512 240C539.614 240 562 217.614 562 190C562 162.386 539.614 140 512 140C484.386 140 462 162.386 462 190C462 217.614 484.386 240 512 240Z" 
        fill="#4040FF"
      />
      <path 
        d="M288 240C315.614 240 338 217.614 338 190C338 162.386 315.614 140 288 140C260.386 140 238 162.386 238 190C238 217.614 260.386 240 288 240Z" 
        fill="#4040FF"
      />
      <path 
        d="M502 190C516.359 190 528 178.359 528 164C528 149.641 516.359 138 502 138C487.641 138 476 149.641 476 164C476 178.359 487.641 190 502 190Z" 
        fill="#FFFFFF"
      />
      <path 
        d="M278 190C292.359 190 304 178.359 304 164C304 149.641 292.359 138 278 138C263.641 138 252 149.641 252 164C252 178.359 263.641 190 278 190Z" 
        fill="#FFFFFF"
      />
      <path 
        d="M400 500C413.255 500 424 489.255 424 476C424 462.745 413.255 452 400 452C386.745 452 376 462.745 376 476C376 489.255 386.745 500 400 500Z" 
        fill="#1D0056"
      />
      <path 
        d="M280 520C335.228 520 380 475.228 380 420C380 364.772 335.228 320 280 320C224.772 320 180 364.772 180 420C180 475.228 224.772 520 280 520Z" 
        fill="#FF8080"
      />
      <path 
        d="M520 520C575.228 520 620 475.228 620 420C620 364.772 575.228 320 520 320C464.772 320 420 364.772 420 420C420 475.228 464.772 520 520 520Z" 
        fill="#FF8080"
      />
      <path 
        d="M400 740C473.638 740 533 680.638 533 607C533 533.362 473.638 474 400 474C326.362 474 267 533.362 267 607C267 680.638 326.362 740 400 740Z" 
        fill="#FF8080"
      />
      <path 
        d="M200 220C213.255 220 224 209.255 224 196C224 182.745 213.255 172 200 172C186.745 172 176 182.745 176 196C176 209.255 186.745 220 200 220Z" 
        fill="#FF8080"
      />
      <path 
        d="M240 140C253.255 140 264 129.255 264 116C264 102.745 253.255 92 240 92C226.745 92 216 102.745 216 116C216 129.255 226.745 140 240 140Z" 
        fill="#FF8080"
      />
      <path 
        d="M560 140C573.255 140 584 129.255 584 116C584 102.745 573.255 92 560 92C546.745 92 536 102.745 536 116C536 129.255 546.745 140 560 140Z" 
        fill="#FF8080"
      />
      <path 
        d="M600 220C613.255 220 624 209.255 624 196C624 182.745 613.255 172 600 172C586.745 172 576 182.745 576 196C576 209.255 586.745 220 600 220Z" 
        fill="#FF8080"
      />
      <path 
        d="M512 172C525.255 172 536 161.255 536 148C536 134.745 525.255 124 512 124C498.745 124 488 134.745 488 148C488 161.255 498.745 172 512 172Z" 
        fill="#FF8080"
      />
      <path 
        d="M288 172C301.255 172 312 161.255 312 148C312 134.745 301.255 124 288 124C274.745 124 264 134.745 264 148C264 161.255 274.745 172 288 172Z" 
        fill="#FF8080"
      />
    </svg>
  );
